...
$namePattern = '^Xiuren(CatalogTest|DatabaseTest|LibraryInteractionTest|MergeTest|StorageTests$|Manager-(build|empty-test|final-safety|render-test|video-test))'
